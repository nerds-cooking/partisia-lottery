...
//     pub entry_counts: AvlTreeMap<Address, u32>, // ! contains address
...
//     pub lottery_id: u8,
//     pub tickets: u32, // Number of tickets to purchase
// }
...
//         .argument(lottery_state.entry_cost * params.tickets)
//         .done();
...
//         // Needs to be u32
//         let random_seed = context.block_time as u32;

//         state_changes.push(zk_compute::select_lottery_winner_start(
//             random_seed,
//             lottery_state.total_entries() as u32,
//             lottery_id,
//             Some(SHORTNAME_ON_WINNER_SELECTED),
//             &VariableKind::Draw {
//                 lottery_id
//             }
//         ));

//         // let winner_index = u32::max(0, ((random_seed & lottery_state.total_entries() as u32) as u32) - 1);

//         // assert!(false, "Total: {:?} Winner: {:?}", lottery_state.total_entries(), winner_index);

//         // // Pick the winner variable

//         // let mut cidx = 0 as u32;

//         // let winner_var_id = *lottery_state.entries_svars.get(winner_index as usize).expect("Winner index out of bounds");

//         // state_changes.push(ZkStateChange::OpenVariables {
//         //     variables: vec![winner_var_id]
//         // });
...
//     // Force debug assertion to check state output
//     assert!(false, "on_winner_selected called with output variable: {:?}", output_variable);

//     (
//         state,
//         vec![],
//         vec![ZkStateChange::OpenVariables {
//             variables: vec![output_variable]
//         }],
//     )
// }
